...
const (
	...
	TagServerWS               = "ws-server"
	TagServerSSE              = "sse-server"
	TagStream                 = "stream"
	TagWSPath                 = "ws-path"
	TagSSEPath                = "sse-path"
	TagKafka                  = "kafka"
	TagKafkaConsumer          = "kafka-consumer"
	TagKafkaPublisher         = "kafka-publisher"
	TagKafkaTopic             = "kafka-topic"
	TagKafkaKey               = "kafka-key"
	TagKafkaHeaders           = "kafka-headers"
	TagKafkaMessage           = "kafka-message"
	TagKafkaCodec             = "kafka-codec"
	TagKafkaAcks              = "kafka-acks"
