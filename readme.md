...
**Команда:** `tg plugin server --out <директория>`
...
**Команда:** `tg plugin client go --out <директория>`
...
**Команда:** `tg plugin client ts --out <директория>`
