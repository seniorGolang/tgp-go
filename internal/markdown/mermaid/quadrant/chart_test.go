...
func TestChart_Build(t *testing.T) {
    ...
    x-axis X
    y-axis Y
    Point A: [0.90, 0.80] color: #ff0000, radius: 12, stroke-width: 5px, stroke-color: #00ff00
    ...
    classDef myClass color: #ff0000, radius: 15, stroke-width: 3px, stroke-color: #00ff00`
...
func TestPointStyle_String(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: "color: #ff0000, radius: 12, stroke-width: 5px, stroke-color: #00ff00",
		},
	}
