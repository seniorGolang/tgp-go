...
// RenderClientError генерирует файл error.ts.
func (r *ClientRenderer) RenderClientError() error {
	...
	// Генерируем интерфейс errorJsonRPC (расширяет Error)
	...
	// Генерируем интерфейс withErrorCode
	...
	// Генерируем функцию defaultErrorDecoder
