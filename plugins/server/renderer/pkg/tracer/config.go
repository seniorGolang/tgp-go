...
func WithNext(f func(ftx *fiber.Ctx) bool) Option {
...
func WithSpanNameFormatter(f func(ftx *fiber.Ctx) string) Option {
	return optionFunc(func(cfg *config) {
...
func WithCustomAttributes(f func(ftx *fiber.Ctx) []attribute.KeyValue) Option {
	return optionFunc(func(cfg *config) {
		cfg.CustomAttributes = f
	})
}

func WithCustomMetricAttributes(f func(ftx *fiber.Ctx) []attribute.KeyValue) Option {
	return optionFunc(func(cfg *config) {
